...
public class EmpImpl {
    ...
    public static void main(String[] args) {
        ...
        Project pp = new Project("123", "gigafiber", "airtel", "tech1");
        Project pp1 = new Project("125", "telenet", "airtel", "bug3");

        List<Project> listu = new ArrayList<>();
        listu.add(pp);
        listu.add(pp1);

        Employee e1 = new Employee(1, "Prajwal", "computer", listu, 35000, "Male");
        Employee e2 = new Employee(2, "Tommy", "computer", listu, 45222, "Male");
